...
function Noticias() {
  return (
    <>
    <div className="container px-4 flex-grow w-full py-4 sm:py-16 mx-auto sm:px-0">
      <h1
        className="text-center text-3xl mb-4 uppercase bg-white text-gray-700 mx-auto px-2"
      >
        Blog
      </h1>
